	...
	<table border="1" cellpadding="1" cellspacing="0">
		...
		<c:forEach var="greens" items="${greensPage.dataList }">
			...
			<tr bgcolor='${ row == 0 ? "#d0d0d0" : "#ffffff"}'>
				...
				<td><input type="button" id="addCar" onclick="checkGreensnumber(${greens.greensid },this)" value="加入购物车" /></td>
			</tr>
...
function checkGreensnumber(greensid,obj) {
	alert(greensid);
	var count = 1;
	xhr.open("get", "CheckGreensnumberServlet?greensid=" + encodeURI(greensid)+"&count="+count, true);
	xhr.send(null);
	alert("123");
