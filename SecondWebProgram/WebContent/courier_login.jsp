			...
			<form action="CourierLoginServlet" method="post" onSubmit="return myfunction()">
				<div id="login">
					...
					<div class="login_context">
						<input type="text" name="couriernumber" class="username" placeholder="请输入用户名">
						<input type="password" name="courierpassword" class="password" placeholder="请输入密码">
						...
						<input type="button" class="regbtn" value="注冊" onclick="location='courier_register.jsp'">
					</div>
				</div>
			</form>
		</div>
