...
<%-- <table border="1" cellpadding="1" cellspacing="0">
   ...
   <c:forEach items="${couriercommentPage.dataList}" var="couriercomment">
				...
				<div class="comment">
					<div class="comment_userid">用户编号：${couriercomment.userid }</div>
					<div class="comment_pubtime">发表时间：${couriercomment.couriercommentpubtime }</div>
					<div class="comment_title">标题：${couriercomment.couriercommenttitle }</div>
					<div class="comment_context">评论内容：${couriercomment.couriercommentcontext }</div>
