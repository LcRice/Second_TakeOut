...
%>
	...
	<div class="header_box">
		...
		<div class="main">
			...
			<form action="${pageContext.request.contextPath}/login" method="post" onSubmit="return myfunction()">
				<div id="login">
					<h2 class="login_title">账号登录</h2>
					<div class="login_context">
						<input type="text" name="usernumber" class="username" placeholder="请输入用户名">
						<input type="password" name="userpassword" class="password" placeholder="请输入密码">
						...
						<input type="button" class="regbtn" value="注冊" onclick="location='user_register.jsp'">
					</div>
				</div>
			</form>
		</div>
