			...
			<form action="RestLoginServlet" method="post" onSubmit="return myfunction()">
				<div id="login">
					...
					<div class="login_context">
						<input type="text" name="restnumber" class="username" placeholder="请输入用户名">
						<input type="password" name="restpassword" class="password" placeholder="请输入密码">
						...
						<input type="button" class="regbtn" value="注冊" onclick="location='rest_register.jsp'">
					</div>
				</div>
			</form>
		</div>
