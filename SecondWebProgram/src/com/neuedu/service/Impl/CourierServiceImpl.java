...
public class CourierServiceImpl implements CourierService {
	...
	public CourierPage getAllCourierPage(int currentPage, int pageSize) {
		// TODO Auto-generated method stub
		CourierPage courierPage = new CourierPage();
		courierPage.setPageSize(pageSize);
		...
		int totalCount = courierDAO.findAllTotalCount();
		courierPage.setTotalCount(totalCount);

		int totalPage = totalCount % pageSize == 0 ? totalCount / pageSize : totalCount / pageSize + 1;
		courierPage.setTotalPage(totalPage);

		List<Courier> courierlist = courierDAO.findAllCourierList(currentPage, pageSize);
