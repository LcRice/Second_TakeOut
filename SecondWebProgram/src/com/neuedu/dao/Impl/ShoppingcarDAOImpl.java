...
public class ShoppingcarDAOImpl implements ShoppingcarDAO {
	...
	public boolean insertShopping(User user, Greens greens, int count) {
		// TODO Auto-generated method stub
		String sql = "insert into shoppingcar values(null,?,?,?)";
		return dbManager.execUpdate(sql, user.getUserid(), greens.getGreensid(), count);
	}
	...
	public boolean updateShopping(User user, Greens greens, int count) {
		// TODO Auto-generated method stub
		String sql = "update shoppingcar set count = count + ? where userid = ? and greensid = ?";

		return dbManager.execUpdate(sql,count, user.getUserid(), greens.getGreensid());
	}
