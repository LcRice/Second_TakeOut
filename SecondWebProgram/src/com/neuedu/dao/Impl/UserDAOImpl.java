...
public class UserDAOImpl implements UserDAO {
	...
	public boolean updateUser(User olduser, User newuser) {
		...
		String sql = "update user set username = ?, userphoto = ?, usernumber = ?, userpassword = ?,"
				+ " usercardnumber = ?, usercardpassword = ?, useramount=?, useraddress = ? where userid = ?";
		return dbManager.execUpdate(sql, newuser.getUsername(),newuser.getUserphoto(),newuser.getUsernumber(),
				newuser.getUserpassword(),newuser.getUsercardnumber(),newuser.getUsercardpassword(),newuser.getUseramount(),newuser.getUseraddress(),
				olduser.getUserid());
	}
