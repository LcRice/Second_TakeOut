...
public class User {
	...
	public User(int userid, String superadminnumber, String username, String usernumber, String userpassword,
			String userphoto, String usercardnumber, String usercardpassword, int useramount, int useraddress) {
		super();
		this.userid = userid;
		this.superadminnumber = superadminnumber;
		this.username = username;
	...
	public String toString() {
		return "User [userid=" + userid + ", superadminnumber=" + superadminnumber + ", username=" + username
				+ ", usernumber=" + usernumber + ", userpassword=" + userpassword + ", userphoto=" + userphoto
				+ ", usercardnumber=" + usercardnumber + ", usercardpassword=" + usercardpassword + ", useramount="
				+ useramount + ", useraddress=" + useraddress + "]";
	}
